...
public final class CmdList
{
	...
	public final ConnectCmd connectCmd = new ConnectCmd();
	public final SwapChatCmd swapChatCmd = new SwapChatCmd();
	...
	public final ElytraSwapCmd elytraSwapCmd = new ElytraSwapCmd();
	...
	public final BoxNukerCmd boxNukerCmd = new BoxNukerCmd();
	...
	public final TargetCmd targetCmd = new TargetCmd();
	...
	public final VillagerCmd villagerCmd = new VillagerCmd();
