...
public final class AutoEatHack extends Hack implements UpdateListener
{
	...
	private final CheckboxSetting allowChorus = new CheckboxSetting(
	...
	private final CheckboxSetting allowGoldenApples =
		new CheckboxSetting("Allow golden apples",
			"Don't let auto eat waste your golden apples.", false);
	
	private final CheckboxSetting allowEnchantedApples =
		new CheckboxSetting("Allow enchanted golden apples",
			"Don't let auto eat waste your golden apples.", false);
	...
	public AutoEatHack()
	{
		...
		addSetting(allowEnchantedApples);
	}
	...
	private boolean isAllowedFood(FoodComponent food)
	{
		...
		if(!allowGoldenApples.isChecked()
			&& food == FoodComponents.GOLDEN_APPLE)
			return false;
		
		if(!allowEnchantedApples.isChecked()
